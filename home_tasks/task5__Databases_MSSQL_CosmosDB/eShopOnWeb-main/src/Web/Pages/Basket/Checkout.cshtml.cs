...
public class CheckoutModel : PageModel
{
    ...
    public async Task<IActionResult> OnPost(IEnumerable<BasketItemViewModel> items, object itemId)
    {
        try
        {
            ...
            var serializeJsonObject = JsonConvert.SerializeObject(updateModel2);


            //v1. Do a http call of some url
            using var client = new HttpClient();
            string url = "https://orderitemsreserver-vsp.azurewebsites.net/api/OrderItemsReserverFunction?name=" + HttpUtility.UrlEncode(serializeJsonObject);
